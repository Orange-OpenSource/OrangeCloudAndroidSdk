...
-----------------------------------------------
We use JitPack.io to deliver an Android library for [Orange Cloud Sdk Android](https://jitpack.io/#Orange-OpenSource/OrangeCloudAndroidSdk/1.0.3)
...
dependencies {
    ...
    compile 'com.github.Orange-OpenSource:OrangeCloudAndroidSdk:1.0.3'
}
```
